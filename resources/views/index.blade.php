...
<head>
    ...
    @if (App::isLocale('vn'))
		<title position-relativele>{{ $common->name }}</title>
	@else
		<title position-relativele>{{ $common->nameeg }}</title>
	@endif
	@yield('meta')
	...
	@else
		<meta name="keywords" content="{!! $common->keywordeg !!}" />
		<meta name="description" content="{!! $common->descriptioneg !!}" />
	@endif
	...
	<link rel="icon" href="{{ asset('upload/hinhanh/logo').'/'.$common->favico }}" type="image/x-icon"/>
</head>
