...
@section('content' )
	<section class="banner wow fadeInUp" style="background: linear-gradient(rgba(3,70,148,.3), rgba(3,70,148,.4)), url('{{ asset('upload/hinhanh/banner/'.$bntrangnews->name) }}') no-repeat center center;background-size: cover">
		<div class="container">
			<h1 class="bold s50 text-center contact-tit text-white banner-tit wow fadeInDown" data-wow-delay="300" data-wow-duration=".8s"><a href="{{ asset('tin-tuc.html') }}"><span>{{ trans('home.title7') }}</span></a>
			</h1>
		</div>
	</section>
