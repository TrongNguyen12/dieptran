                     ...
                     <div class="row">
                        <div class="col-md-8 col-xs-12">
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="shortdes" id="Text_min1" rows="5"  class="form-control">{{ $data->shortdes }}</textarea>
                           </div>
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="box box-solid">
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">  
                                    ...
                                    <li>
                                       <a style="font-weight: 400px;"><label><input type="checkbox" name="status" <?php if($data->status==1){echo 'checked';}?>/> Hiển thị</label></a>
                                    </li>
                                    <li>
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">
                                    <div id="li-cate-admin">
                                       <!----------------------------------------->
                                       <?php
                                          $check=DB::table('cate_ids')->select('cate_id','id')->where('product_id',$data->id)->get();
                                       ...
                                       <!------------->
                                       <li id="nhan-menu" >
                                          <label class="selectit"><input <?php foreach($check as $min){if($min->cate_id == $obj->id){echo 'checked';}} ?> value="{{ $obj->id }}" type="checkbox" name="txtProductCate[]" /> {{ $obj->name }}</label>
                                          <!------------->   
                                          <?php       
                                             $bientam = new App\ProductCate;
                                             
                                             $bientam->ChildMenu($obj->id,$data->id); // Nếu có menu con thì sẽ được hiển thị
                           ...
                           <div class="box box-solid" style="display: none;">
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">
                                    <li id="right-col-li" >
                                       <img src="{{ asset('upload/product/'.$data->images2) }}" style="max-width: 100%;" />
                           ...
                           <div class="box box-solid">
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">
                                    <li id="right-col-li" >
                                       <img id="output" src="{{ asset('upload/product/'.$data->images) }}" />
                                    ...
                                    <li id="right-col-li" >
                                       <div class="form-group">
                                          <div class="row">
                                             ...
                                             <div style="position: relative;" class="file-preview-frame krajee-default  kv-preview-thumb" id="{!! $key !!}">
                                                <img style="max-width: 200px;" src="{!! asset('uploads/images/img_detail/' . $item['image']) !!}" class="prodetail_img" idImg="{!! $item['id'] !!}" id="{!! $key !!}">
                                                <a style="position: absolute;right: 0px;top: 0px;z-index: 999;" href="backend/product/delimg/{{$item->id}}" type="button" id="del_img" class="btn btn-danger btn-circle icon_del"><i class="fa fa-times"></i></a>
                                             </div>
                                             @endforeach
                                             @endif
                                             <div style="clear: both;"></div>
                                    ...
                                    <div class="tk-block">
                                       ...
                                       <select name="hang_id" id="multiple" multiple>
                                          <?php
                                             ...
                                             ?>
                                          <option <?php if($data->hang_id == $iteam->id){echo 'selected ';}?>  value="<?= $iteam->id?>"><?= $iteam->name?></option>
                                          <?php } ?>
                                       </select>
                                    </div>
                                 </ul>
                      ...
                      <div class="tab-pane" id="tab_2">
                          <?php
                            $exp1=explode('|min|',$data->link1);
                            $exp2=explode('|min|',$data->link2);
                            foreach($exp1 as $k=>$item){
                          ?>  
                            <div class="con"><div class="col-md-5 col-xs-12"><input value="<?=$item?>" placeholder="Tiêu đề thông số" id="Text1" name="link1[]" class="form-control images-add" type="text"></div><div class="col-md-5 col-xs-12"><input value="<?=$exp2[$k]?>" placeholder="Nội dung thông số" id="Text1" name="link1Content[]" class="form-control images-add" type="text"></div><input id="bnt-images-add" type="button" class="form-control btnRemove" value="Xóa"><div class="clearfix"></div></div> 
                          <?php } ?>  
                      ...
                      <div class="tab-pane" id="tab_3">
                          <?php 
                            $exp3=explode('|min|',$data->link1_eg);
                            $exp4=explode('|min|',$data->link2_eg);
                            foreach($exp3 as $m=>$in){
                          ?>  
                            <div class="con"><div class="col-md-5 col-xs-12"><input value="<?=$in?>" placeholder="Tiêu đề thông số" id="Text1" name="link1_eg[]" class="form-control images-add" type="text"></div><div class="col-md-5 col-xs-12"><input value="<?=$exp4[$m]?>" placeholder="Nội dung thông số" id="Text1" name="link1Content_eg[]" class="form-control images-add" type="text"></div><input id="bnt-images-add" type="button" class="form-control btnRemove" value="Xóa"><div class="clearfix"></div></div> 
                          <?php } ?>  
                      ...
                      <div class="tab-pane" id="tab_4">
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="shortdes_eg" rows="5" id="Text_min3" class="form-control">{{ $data->shortdes_eg }}</textarea>
                           </div>
                           <div class="clearfix"></div>
                           <div class="box box-info">
                              <div class="box-header">
                              ...
                              <div class="box-body pad">
                                 <textarea name="txtContent_eg" id="Text_min4" cols="50" rows="5">{{ $data->content_eg }}</textarea>
                              </div>
                           </div>
                           <div class="clearfix"></div>
                           <div class="form-group">
