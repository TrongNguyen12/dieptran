                     ...
                     <div class="row">
                        <div class="col-md-8 col-xs-12">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="txtNameHome"  class="form-control" />
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="shortdes" rows="5" class="form-control" id="Text_min3"></textarea>
                           </div>
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="box box-solid">
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">                                    
                                    <li>
                                       <a><span><input type="checkbox" name="status" checked="checked"> Hiển thị trang chủ</span></a>
                                    </li>
                                    <li>
                                       <a style="line-height: 35px;"><input type="number" min="1" name="stt" value="" class="form-control" style="width: 100px;margin-right: 10px;float: left;margin-bottom: 10px;"/> Số thứ tự</a>
                           ...
                           <div class="box box-solid">
                            ...
                            <div class="box box-solid">
                              <div class="box-header with-border">
                                 <h3 class="box-title">Thêm thư viện ảnh</h3>
                                 <div class="box-tools">
                                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                    </button>
                                 </div>
                     ...
                     <div class="row">
                        <div class="col-md-12 col-xs-12">
                           ...
                           <div class="form-group">
                              ...
                              <textarea id="Text_min2" name="shortdes_eg" rows="5" class="form-control"></textarea>
                           </div>
                           <div class="box box-info">
                              <div class="box-header">
