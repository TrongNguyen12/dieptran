...
<section class="content">
   <div class="box">
      ...
      <div class="box-body">
         <form method="post" action="backend/slider/edit?id={{$data->id}}&type={{ $type }}" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="row">
               <div class="col-md-8 col-xs-12">
                  <div class="form-group @if ($errors->first('fImages')!='') has-error @endif">
                     <div class="form-group">
                        <img src="{{ asset('upload/hinhanh/slider/'.$data->photo) }}" onerror="this.src='{{asset('public/admin_assets/images/no-image.jpg')}}'" class="img-responsive"  alt="NO PHOTO" />
