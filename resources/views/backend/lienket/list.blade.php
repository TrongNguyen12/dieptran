          ...
          <table id="example1" class="table table-bordered table-hover">
            ...
            <thead>
              ...
              <tr>
                ...
                @if($_GET['type']!='lien-ket')<th>Hình ảnh</th>@endif
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <!-- <div class="form-group"> 
                    ...
                    @if($item->noibat>0)
                      ...
                      <a href="backend/lienket/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Nổi bật</a>

                    @else

                      <a href="backend/lienket/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Nổi bật</a>
