...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="{!! route('backend.lienket.postAdd') !!}" enctype="multipart/form-data">
                      ...
                      <?php } ?> 
                         ...
                         <div class="box box-info">
    		                ...
    		                <div class="box-body pad">
    		        			<textarea name="txtDesc" id="Text_min" cols="50" rows="5"></textarea>
    		        		</div>
    		        	</div>
    					<?php } ?>
