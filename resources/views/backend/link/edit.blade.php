...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form method="post" action="backend/link/edit?id={{$id}}&type={{ @$_GET['type'] }}" enctype="multipart/form-data">
        		...
        		<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
              	...
              	<div class="col-md-8 col-xs-12">
                        ...
                        <div class="form-group">
					      	<label for="ten">Tiêu đề</label>
					      	<input type="text" name="txtName2" value="{{ $data->name2 }}"  class="form-control" />
						</div>
                        <div class="form-group">
					      	<label for="ten">Link</label>
					      	<input type="text" name="txtLink" value="{{ $data->link }}"  class="form-control" />
						</div>
				</div>
                              ...
                              <div class="box box-solid">
                                ...
                                <div class="box-body no-padding">
                                  <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="backend/link"><i class="fa fa-trash-o"></i> Thoát</a></li>
                                  </ul>
                                </div>
                                <!-- /.box-body -->
                              </div>
