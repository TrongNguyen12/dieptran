...
<script type="text/javascript">
    function changepos() {
        document.frm1.action = "backend/newscate/changepos";
           ...
           <table id="example1" class="table table-bordered table-striped"> 
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ url($item->alias) }}.html">{{$item->name}}</a></td>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  @if($item->status>0)
                    ...
                    <a href="backend/newscate/edit?id={{$item->id}}&hienthi={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>

                  @else

                    <a href="backend/newscate/edit?id={{$item->id}}&hienthi={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No hiển thị</a>
                  ...
                  @if($item->noibat>0)
                    ...
                    <a href="backend/newscate/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Bottom</a>

                  @else

                    <a href="backend/newscate/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No bottom</a>
