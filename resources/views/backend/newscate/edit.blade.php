...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form method="post" action="backend/newscate/edit?id={{$data->id}}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="desc">Mô tả</label>
    								      	...
    								      	<textarea style="min-height: 185px;width: 100%;" name="mota"  rows="5" class="form-control">{{ $data->mota }}</textarea>
