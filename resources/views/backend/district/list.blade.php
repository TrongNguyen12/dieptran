...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = homeUrl()+"/backend/district/"+listid+"/delete_list";
    });
...
<script type="text/javascript">
    function changepos() {
        document.frm1.action = "backend/district/changepos";
           ...
           <table id="example1" class="table table-bordered table-striped"> 
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>  <a href="backend/district/edit?id={{$item->id}}">{{$item->name}}</a> 
                ...
                <td class="text-center ">
                  ...
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/district/edit?id={{$item->id}}">Edit</a>

                </td>

                <td class="text-center">

                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/district/{{$item->id}}/delete">Delete</a>
