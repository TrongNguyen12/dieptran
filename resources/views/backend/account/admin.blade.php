...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form method="post" action="backend/account/updateinfo" enctype="multipart/form-data">
              		...
              		<div class="col-md-6 col-xs-12">
						...
						<div class="form-group @if ($errors->first('fImages')!='') has-error @endif">
							...
							<div class="form-group">
								...
								<img src="{{ asset('upload/account/'.$data->photo) }}" onerror="this.src='{{asset('public/admin_assets/images/no-image.jpg')}}'" width="200"  alt="NO PHOTO" />
