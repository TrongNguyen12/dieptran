...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	<form method="post" action="backend/account/postedituse?id={{$data->id}}" enctype="multipart/form-data">
        		<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
          		<div class="row">
              		<div class="col-md-6 col-xs-12">
					    ...
					    <div class="form-group">
					      	<label for="alias">Mật khẩu hiện tại</label>
					      	<input type="text" readonly="" value="{{ $data->password2 }}"  class="form-control" />
						</div>   
