...
<section class="content">
   <div class="box">
      ...
      <div class="box-body">
         <form method="post" name="frmEditProduct" action="backend/sevices/edit?id={{$data->id}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="box box-solid ">
                              ...
                              <div class="box-body no-padding">
                                 <ul class="nav nav-pills nav-stacked">
                                    <li id="right-col-li" >
                                       <img src="{{ asset('upload/hinhanh/sevices/'.$data->photo) }}" id="output" />
