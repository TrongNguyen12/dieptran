...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="{!! route('backend.categorys.postAdd') !!}" enctype="multipart/form-data">
	                  		...
	                  		<div class="row">
		                  		...
		                  		<div class="col-md-6 col-xs-12">
			                    	...
			                    	<div class="form-group">
								      	...
								      	<select name="txtCategorys" class="form-control">
			    ...
			    <div class="box-footer">
			    	...
			    	<div class="row">
						...
						<div class="col-md-6">
					    	...
					    	<button type="button" onclick="javascript:window.location='backend/categorys'" class="btn btn-danger">Thoát</button>
